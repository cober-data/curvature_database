...
def ts_plot(df, nome, units,space):
    ...
    colors = ['#E0D253','#7AADD4','#0A3254','#1D4568','#30587C','#486B8E','#607EA0','#7891B0','#8FA4C0','#A7B7CF','#BFCBDE','#031820','#10022D','#090437','#060C41','#081E4B','#081E4B','#023545','#B9C3C9','#003233','#023545']
    print(df.columns)
